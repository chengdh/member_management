...
class member_class_change_config(osv.osv):
    _name = "member_management.member_class_change_config"
    _description = "根据会员积分高低自动升降级别的设置"

    _columns = {
            "member_class_id" : fields.many2one('member_management.member_class','member_class_id',required = True,help = "会员等级"),
            ...
            'up_member_class_id' : fields.many2one('member_management.member_class',"up_member_class_id",required = True,help = "升级会员类别"),
            'down_points' : fields.integer('down_points',required = True,help = "降级累计积分"),
            'down_member_class_id' : fields.many2one('member_management.member_class',"down_member_class_id",required = True,help = "降级会员类别"),
